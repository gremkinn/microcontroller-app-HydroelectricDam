...
int openLED_status = 0;
int closeLED_status = 0;

void offLED(void) {
    PORTAbits.RA3 = 0, PORTAbits.RA2 = 0, PORTAbits.RA1 = 0;
}

void emergency_LED(void) {
    PORTAbits.RA3 = 1, PORTAbits.RA2 = 1, PORTAbits.RA1 = 1;
}
...
void openLED(void) {
    ...
    PORTAbits.RA3 = 1, PORTAbits.RA2 = 0, PORTAbits.RA1 = 1;
}
...
void powerONLED(int time) {
    PORTAbits.RA3 = 1, PORTAbits.RA2 = 0, PORTAbits.RA1 = 0;
    custom_delayLED(time);
    PORTAbits.RA3 = 0, PORTAbits.RA2 = 1, PORTAbits.RA1 = 0;
    custom_delayLED(time);
    PORTAbits.RA3 = 0, PORTAbits.RA2 = 0, PORTAbits.RA1 = 1;
    custom_delayLED(time);
    PORTAbits.RA3 = 0, PORTAbits.RA2 = 1, PORTAbits.RA1 = 0;
    custom_delayLED(time);
}
